...
<div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-500 dark:text-gray-800 mx-auto">
	...
	<div className="flex justify-center space-x-4">
		<button onClick={handleGoogleSignin} aria-label="Log in with Google" className="p-3 rounded-sm">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current cursor-pointer">
		...
		<button  aria-label="Log in with GitHub" className="p-3 rounded-sm cursor-pointer">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
