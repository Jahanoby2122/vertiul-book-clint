...
const handleSignup = (e) => {
  ...
  createUser(email, password)
    ...
    return (
        <>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-500 dark:text-gray-800 mx-auto">
	...
	<form onSubmit={handleSignup} className="space-y-6">
        ...
        <div className="space-y-1 text-sm">
			...
			<input type="text" name="photo" placeholder="Enter your photo " className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
		</div>
		<div className="space-y-1 text-sm">
		...
		<button className="block w-full p-3 text-center rounded-sm dark:text-gray-50 dark:bg-violet-600">Signup</button>
	</form>
	...
	<div className="flex justify-center space-x-4">
		<button aria-label="Log in with Google" className="p-3 rounded-sm cursor-pointer">
