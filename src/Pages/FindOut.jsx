...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-gray-200 py-5 transition-all duration-300">
      <button
        className="flex justify-between items-center w-full text-left text-base font-semibold text-gray-800 hover:text-blue-500 transition-colors"
...
const FindOut = () => {
  return (
    <section className=" py-20 px-6 sm:px-10 lg:px-16 rounded-3xl  overflow-hidden relative">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 relative z-10">
        
        {/* Left section */}
        <div className="flex flex-col justify-center">
          <h2 className="text-sm font-semibold tracking-widest text-blue-500 mb-3">FAQs</h2>
          ...
          <button className=" btn btn-primary bg-white  text-black px-6 py-3  transition duration-300 w-fit">
            Contact Support
          </button>
        </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute bottom-0 right-0 w-40 h-40 bg-blue-100 rounded-full blur-2xl opacity-20"></div>
        <div className="absolute top-1/2 left-1/3 w-96 h-96 border border-blue-300 rounded-full opacity-10 animate-pulse"></div>
      </div>
    </section>
  );
};
